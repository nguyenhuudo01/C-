...
namespace BTL_QLNS_NHOM1
{
    public partial class FrmPhongBan : Form
    {
        ...
        private void FrmPB_Load(object sender, EventArgs e)
        {
            ...
            dataBase.loadcombobox(cbTenPhong, "select * from TblPhongBan", 2);
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cbTenPhong.Text = dataGridView1.Rows[i].Cells[2].Value.ToString();
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string insert = "insert into TblPhongBan values('" + cbMaBoPhan.Text + "',N'" + txtMaPhong.Text + "',N'" + cbTenPhong.Text + "',N'" + dateTimePicker1.Text + "',N'" + txtGhiChu.Text + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                string update = "update TblPhongBan set MaBoPhan=N'" + cbMaBoPhan.Text + "',TenPhong=N'" + cbTenPhong.Text + "',NgayThanhLap=N'" + dateTimePicker1.Text + "',GhiChu=N'" + txtGhiChu.Text + "' where MaPhong=N'" + txtMaPhong.Text + "'";
